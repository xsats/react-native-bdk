...
import { CreateTransactionInput, LoadWalletInput, LoadWalletResponse, SendTransactionInput, SendTransactionResult, AddRecipientInput, AddressInfo, GetAddressInput, PsbtSerialised } from './utils/types';
declare class BdkInterface extends BdkClient {
     ...
     */
    createTransaction(args: CreateTransactionInput): Promise<Result<{
